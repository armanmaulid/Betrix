...
import { updateProfile, changePassword, changeEmail, getSessions, revokeSession, type DeviceSession } from "../lib/api/authClient";
import { fetchUsageMe, type UsageSummary } from "../lib/api/usageClient";
import { 
      ...
      <div className="mt-4 border border-[var(--border)] bg-[var(--bg)]">
        ...
        <div className="p-4">
          ...
          <div className="w-full mt-4">
            ...
            {usageSummary.byTaskType.map((task: any, idx: any) => (
              <div key={idx} className="bx-table-row">
