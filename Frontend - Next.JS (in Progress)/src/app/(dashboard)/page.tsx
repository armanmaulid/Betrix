...
import { EconomicCalendar } from "@/features/market/components/EconomicCalendar";
import { useAuth } from "@/features/auth/context/AuthContext";

const TradingViewWidget = dynamic(
  () => import("@/features/market/components/TradingViewWidget").then((mod) => mod.TradingViewWidget),
  { ssr: false }
);
